...
const LastBanner = () => {
    return (
        <div className='bg-[#F3F0FF] rounded-md p-6 md:p-14 w-[95%] md:max-w-7xl mx-auto'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center'>
                <article className='w-full md:w-9/12 text-center md:text-left mb-6 md:mb-0'>
                    Pixlia Tech is the all-in-one platform empowering businesses to find, hire, manage, and optimize both tech and HR talent seamlessly in a single solution.
                </article>
