...
const Banner = () => {
    return (
        <section className='max-w-7xl mx-auto my-12 px-5 md:px-0 md:my-24'>
            <div>
                ...
                <div className="flex justify-center items-center">
                    <img
                        src="banner.png"
                        className='w-full md:w-[90%] lg:w-[80%] xl:w-[70%] h-auto max-h-[400px] object-contain'
                        alt="Team working illustration"
                    />
                </div>

                <article className='mt-10 md:mt-16 text-gray-700 text-sm md:text-base lg:text-lg'>
                    <span className='font-bold text-black'>Pixlia Tech</span> connects businesses with expert tech consultants, developers, and HR professionals. We provide tailored solutions to drive innovation, optimize processes, and build high-performing teams for business success.
                </article>
