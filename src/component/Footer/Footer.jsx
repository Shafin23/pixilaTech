...
const Footer = () => {
    return (
        <footer className="bg-[#2A2727] p-8 md:p-14 text-white mt-24">
            <div className="flex flex-col md:flex-row justify-between items-start w-full md:w-[95%] mx-auto space-y-10 md:space-y-0">
